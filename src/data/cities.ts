...
/**
 * 51 город: 47 канонических Ticket to Ride: Europe + 4 восточных (Поволжье).
...
export const CITIES: City[] = [
  ...
  // Поволжье и восток (расширение карты — нет в коробочной игре)
  { id: 'nizhny', name: 'Нижний Новгород', x: 1050, y: 235, labelDy: -22 },
  { id: 'kazan', name: 'Казань', x: 1175, y: 250 },
  { id: 'samara', name: 'Самара', x: 1205, y: 350 },
  { id: 'volgograd', name: 'Волгоград', x: 1110, y: 430 },
